...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <motion.div
      ...
      className="flex justify-between items-center px-6 sm:px-10 lg:px-12 xl:px-16 py-3 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70"
    >
      <img
        src={theme === "dark" ? assets.logodarkduct : assets.logoduct}
        className="h-16 sm:h-20 lg:h-9 w-auto object-contain"
        alt="Logo"
      />

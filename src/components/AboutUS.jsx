...
const AboutUS = () => {
  ...
  return (
    ...
    className='flex flex-col items-center gap-4 px-4 sm:px-12 lg:px-24 xl:px-40 py-20 text-gray-800 dark:text-white'>
      ...
      <Title title='About Us' desc='Duct Solution is a professional HVAC service company in Maryland dedicated to delivering reliable, efficient, and high-quality air conditioning and ventilation solutions for both residential and commercial clients.'/>
      ...
      <div className='grid md:grid-cols-2 gap-10 items-center w-full'>
        ...
        <motion.div
          ...
          <h2 className='text-3xl sm:text-4xl font-bold'>
            Your Partner in <span className='text-primary'>Climate Efficiency</span>
          </h2>
          <p className='text-gray-600 dark:text-gray-300 leading-relaxed'>
            We combine technical expertise with personalized service to ensure every HVAC project delivers comfort, performance, and long-term energy efficiency. Our commitment is to provide reliable solutions, precise installations, and timely maintenance — always prioritizing customer satisfaction and safety.
          </p>
          <p className='text-gray-600 dark:text-gray-300 leading-relaxed'>
            
            With years of hands-on experience and a strong focus on quality, we bring innovation and efficiency to every system we install. From air conditioning and ventilation to duct cleaning and repair, we’re your trusted partner for complete climate solutions.
          </p>
          ...
          >
            ...
            >
              ...
              <span className='tracking-wide'>Visita nuestro Facebook</span>
            </a>
          </motion.div>
